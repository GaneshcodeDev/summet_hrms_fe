...
export const seedMenuItems: MenuItem[] = [
  ...
  { id: "menu-performance", label: "Performance", icon: "TrendingUp", href: "/performance", parentId: null, order: 9, module: "Performance" },
  { id: "menu-recruitment", label: "Recruitment", icon: "Briefcase", href: "/recruitment", parentId: null, order: 10, module: "Recruitment" },
  { id: "menu-training", label: "Training", icon: "GraduationCap", href: "/training", parentId: null, order: 11, module: "Training" },
  { id: "menu-assets", label: "Assets", icon: "Laptop", href: "/assets", parentId: null, order: 12, module: "Assets" },
  { id: "menu-reports", label: "Reports", icon: "BarChart3", href: "/reports", parentId: null, order: 13, module: "Reports" },
  { id: "menu-events", label: "Events", icon: "Calendar", href: "/events", parentId: null, order: 14, module: "Events" },
  { id: "menu-access-control", label: "Access Control", icon: "ShieldCheck", href: "/access-control", parentId: null, order: 15, module: "AccessControl" },
  { id: "menu-settings", label: "Settings", icon: "Settings", href: "/settings", parentId: null, order: 16, module: "Settings" },
];
